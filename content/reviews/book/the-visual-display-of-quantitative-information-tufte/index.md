...
The problem is that Tufte turned out to be a voice crying in the wilderness.  There are the major flaws, like the use of flashy cluttered "infographics" that combine the worst features of text-heavy articles and data graphics.  But then there are the minor things. I have at my fingertips about a half-dozen data visualization packages, from Excel (boo!) to ggplot and bokeh.  And not a single one, by default, does everything that Tufte says.  They get close, but the defaults are not quite minimalist enough. And truly great graphs, like Minard's plot of Napoleon's invasion of Russia, with his army vanishing into the snows, still require an artist's touch.