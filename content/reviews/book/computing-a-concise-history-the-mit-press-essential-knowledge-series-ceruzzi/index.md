...
rating: 4.0
reads:
- date_finished: 2021-09-03
  year: 2021
tags:
- history
title: 'Computing: A Concise History (The MIT Press Essential Knowledge series)'
type: book
---

This book definitely delivers on the "concise" part of the title, coming in at a little over 150 small pages, but concision means making choices on what to exclude, and in this case, that's most of the technical detail.  Ceruzzi's thesis links computing to four major concepts: digital representation of characters and logic as binary 0s and 1s; the combination of data and control in a unified representation, communication between computers, and the increasing fluidity of the user interface.
...
The 1960s and 1970s saw the relegation of mechanical input via punched cards in favor of much faster electronic inputs like tape decks, experiments in networking on ARPANET, and the golden bullet, the integrated circuit, which was a computer on a chip rather than painstakingly assembled components on boards. Integrated circuits led the personal computing revolution of the 1980s and the triumph of the mobile internet that we know today.
